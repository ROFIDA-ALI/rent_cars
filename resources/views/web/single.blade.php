...
@include('web.includes.head')
  ...
  <body>
    ...
    {{-- <div class="hero inner-page"  url"{{ asset('assets/images/hero_1_a.jpg') }}";> --}}
          ...
          <div class="row align-items-end ">
            <div class="col-lg-12">
              ...
              <div class="intro">
                ...
                <h1><strong>{{$cars->carTitle}}</strong></h1>
                <div class="pb-4"><strong class="text-black">{{$cars->created_at}}</strong></div>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <p class="lead">{{$cars->description}}</p>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="categories">
                ...
                <li><a href="#">{{$category->categoryName}} <span>{{$category->cars_count}}</span></a></li>
                @endforeach
