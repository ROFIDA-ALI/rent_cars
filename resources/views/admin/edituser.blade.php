									...
									<form action="{{route('updateUser',$users->id) }}" method="post" enctype="multipart/form-data"
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" name="name" value="{{ $users->name}}" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align"@checked($users->active)>Active</label>
											<div class="checkbox">
												<label>
